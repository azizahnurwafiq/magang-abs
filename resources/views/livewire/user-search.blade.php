                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{route('admin.manage_user.edit', $user->id)}}" class="btn btn-primary dropdown-item "><i class="fa fa-edit"></i> Edit</a>
                            
                            <form action="{{route('admin.manage_user.destroy', $user->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
