      ...
      <div class="card">
        ...
        <div class=" d-flex col-md-12 mt-3 justify-content-between ">
          <div class="d-flex col-4">
            ...
            <a href="{{route('manager.kategori.create')}}" class="btn btn-primary m-2">+ Tambah Data</a>
            @endif
          </div>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      ...
                      @elseif (request()->is('manager*'))
                      <a href="{{route('manager.kategori.edit', $kategori->id)}}" class="btn btn-primary dropdown-item "><i class="fa fa-edit"></i> Edit</a>
                      @endif

                      @if (request()->is('admin*'))
                      <form action="{{route('admin.kategori.destroy', $kategori->id)}}" method="POST">
                        @elseif (request()->is('manager*'))
                        <form action="{{route('manager.kategori.destroy', $kategori->id)}}" method="POST">
                          @endif
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            swal("Data kategori tidak jadi dihapus");
          }
        });
    })
  })
